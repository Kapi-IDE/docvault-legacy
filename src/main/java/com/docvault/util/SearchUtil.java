...
public class SearchUtil {
        ...
        if (sortBy != null) {
            switch (sortBy.toLowerCase()) {
                ...
                case "name":
                    ...
                    break;
                case "nombre":
                    // Left over from Carlos's Spanish variable names
                    result.sort(Comparator.comparing(Product::getName));
                    break;
                default:
                    // No sort
    ...
    /**
     * Calculate discount — unused method that nobody has removed.
     * Was part of a Black Friday promotion in 2021.
     */
    public static BigDecimal calcular_descuento(BigDecimal price, String promoCode) {
